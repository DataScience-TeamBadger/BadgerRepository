...
def getPoints(parsefile,colnumLat=0,colnumLong=1,kmlName="coordinates"):
    sflst=_hi_(parsefile,colnumLat,colnumLong,kmlName)
    points=[]   
    for sf in sflst:
        for p in sf:
            points.append(p)
...
def _hi_(param,colnumLat,colnumLong,kmlName):
